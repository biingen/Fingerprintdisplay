...
namespace FPD
{
    public abstract class HID_Handler : IDisposable
    {
        ...
        public abstract void WriteCommand(int Command_type, int addr_in, int datacount);
    ...
    class SDP_Handler : HID_Handler
    {
        ...
        public override void WriteCommand(int Command_type, int addr_in, int datacount)
        {
            byte[] CommandBuffer = new byte[17];
            byte[] count = new byte[4];
            byte[] addr = new byte[4];
    ...
    class BL_Handler : HID_Handler
    {
        ...
        public void WriteCommand(int Command_type, int para_1_in, int para_2_in, byte[] data)
        {
            ...
            CommandBuffer[5] = (Command_type == 4) ? Convert.ToByte(0x01) : Convert.ToByte(0x00);    //Flags
        ...
        public override void WriteCommand(int Command_type, int para_1_in, int para_2_in)
        {
        ...
        public void WriteCommand(byte[] Command_type, byte[] para_1_in, byte[] para_2_in)
        {
            byte[] CommandBuffer = new byte[1021]; //2+12+1(Report ID)
        ...
        public void WriteCommand(byte[] Command_type, byte[] para_1_in, int data_len, byte[] data)
        {
            byte[] CommandBuffer = new byte[1021]; //6+12+1(Report ID)+4 byte data
